...
<CardGrid>
	...
	<LinkCard title='Offline'  target="_blank" href='https://github.com/julcioo/PrismLauncher-Cracked/releases/download/8.0-cracked/PrismLauncher-Windows-MSVC-Portable-8.0-cracked.zip'/>
</CardGrid>
...
Modpacks podem ser instalados de duas formas principais, baixando de repositorios online ou importando .zip's, siga os passos adequados:

<CardGrid>
	<LinkCard title='Repositorios (CurseForge, Modrinth)' href='/'/>
	<LinkCard title='.zip'  target="_blank" href='../1-installzip/'/>
</CardGrid>
